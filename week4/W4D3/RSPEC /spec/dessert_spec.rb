...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "sets a quantity" do 
      expect(brownie.qunaity).to eq(100)
    end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ...
      brownie.mix!
      expect(brownie.ingredients).not_to eq(ingredietns)
      expect(brownie.ingredient.sort).to eq(ingredient.sort)
  ...
  describe "#eat" do
    it "subtracts an amount from the quantity" do
      brownie.eat(20)
      expect(brownie.qunaity).to eq(80)
    end
